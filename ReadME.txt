...
Please download this project. You will find ContactController which has all required REST APIs.
You can use Postman Application to run below services. 
...
Below is the format of Contact object to input
 {     
        "FirstName": "Nirav",
        "LastName": "Gandhi",
        "Email": "Nirav.Gandhi@hotmail.com",
        "PhoneNumber": "0001 111 222",
        "Status": true
    }
